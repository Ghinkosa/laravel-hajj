            ...
            <div class="flex items-center justify-center mt-8">
                <div class="flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        ...
                        <img src="{{ asset('/images/hajj.png') }}" alt="Image" width="200px">
                        </span>
                    </a>
                </div>
            </div>
            <nav>
                ...
                @canany('Post access','Post add','Post edit','Post delete')
                 <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.posts.index') ? 'active' : '' }}"
                    ...
                    <span class="mx-3">Hajira</span>
                </a>
                @endcanany

                @canany('Hajira access','Hajira add','Hajira edit','Hajira delete')
                 <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Route::currentRouteNamed('admin.hajira.index') ? 'active' : '' }}"
                    href="{{ route('admin.posts.index')}}">
                    <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
